...
import 'package:loja_virtual/tiles/cart_title.dart';
...
class CartScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Meu carrinho ",textAlign: TextAlign.center, style: TextStyle(fontSize: 20.0,fontWeight: FontWeight.bold),),
        actions: <Widget>[
          Container(
            ...
            return Container(
              ...
              child: Column(
                ...
                children:<Widget> [
                  ...
                  Text("Faça o login para adicionar produtos", style: TextStyle(fontSize: 20.0,fontWeight: FontWeight.bold),
